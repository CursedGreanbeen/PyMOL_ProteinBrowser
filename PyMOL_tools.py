...
SCRIPTS_DIR = Path("/home/mullagaliamova/ClaudeWorkspace/PROJECTS/cdr-h3-folding/scripts")
...
from PyMOL_tools.core.fasta_edit import (
    filter_fasta_for_current_object as fasta_modify,
    get_chains_from_current_obj as get_chains,
)
...
globals()['fasta_modify'] = fasta_modify
globals()['get_chains'] = get_chains
